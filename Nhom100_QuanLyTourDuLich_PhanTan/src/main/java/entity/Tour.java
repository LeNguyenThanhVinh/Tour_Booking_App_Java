...
public class Tour implements Serializable{
	...
	public String toString() {
		return "Tour [maTour=" + maTour + ", tenTour=" + tenTour + ", giaTour=" + giaTour + ", soLuongNguoi="
				+ soLuongNguoi + ", ngayKhoiHanh=" + ngayKhoiHanh + ", ngayKetThuc=" + ngayKetThuc + ", moTa=" + moTa
				+ ", tinhTrang=" + tinhTrang + ", hinhAnh=" + hinhAnh + "]";
	}
