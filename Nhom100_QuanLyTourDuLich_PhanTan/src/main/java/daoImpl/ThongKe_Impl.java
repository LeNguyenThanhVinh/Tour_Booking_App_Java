...
public class ThongKe_Impl extends UnicastRemoteObject implements ThongKe_DAO {
	...
	public double DoanhThuTheoQuy(String nam, String thang1, String thang2, String thang3) throws RemoteException {
		double tong = 0;
		String sql = "select  SUM(giaTour) from Ves v join Tours t on v.maTour=t.maTour "
	...
	public List<Tour> thongKeTheoNgay(String tuNgay, String denNgay) throws RemoteException {
		...
		String sql = "select  t.maTour, t.tenTour ,COUNT(t.maTour) AS 'SOLUONGVE', SUM(t.giaTour) as 'TONGTIEN' from Ves v join Tours t on v.maTour = t.maTour "
