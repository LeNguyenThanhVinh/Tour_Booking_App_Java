...
public class QuanLiThongKe extends JPanel implements ActionListener {
	...
	public QuanLiThongKe() throws Exception {
		...
		JLabel lblTieuDe = new JLabel("Quáº£n LÃ½ Thá»‘ng kÃª");
		...
		String[] chuoi = {"Top","TÃªn Tour","Tá»•ng Doanh Thu"};
		...
		//table.getColumn("Sá»‘ lÆ°á»£ng Ä‘Ã£ bÃ¡n").setMaxWidth(45);
...
//		table.getColumn("Sá»‘ LÆ°á»£ng VÃ© Ä?Ã£ BÃ¡n").setCellRenderer(midRenderer);
		table.getColumn("Tá»•ng Doanh Thu").setCellRenderer(midRenderer);
		...
		txtTitleTopTour.setText("Top tour Ä‘Ã£ bÃ¡n");
		...
		JLabel lblTuNgay = new JLabel("Tá»« ngÃ y:    ");
		...
		JLabel lblDenNgay = new JLabel("Ä?áº¿n ngÃ y:    ");
		...
		btnthongke = new JButton("Thá»‘ng KÃª");
		...
		JLabel lblChonNam = new JLabel("Chá»?n NÄƒm:");
		...
		btnQuy1 = new JButton("Thá»‘ng KÃª QuÃ½ I");	
		btnQuy2 = new JButton("Thá»‘ng KÃª QuÃ½ II");
		btnQuy3 = new JButton("Thá»‘ng KÃª QuÃ½ III");
		btnQuy4 = new JButton("Thá»‘ng KÃª QuÃ½ IV");
		pnhang2.add(btnQuy1);
...
//		lblNgaySoLuongHoaDon = new JLabel("");
		...
		txtTitleTongDoanhThu.setText("Tá»•ng doanh thu ");
		...
		txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ bÃ¡n");
		...
		txtTittleSoLuongKhachHang.setText("Tá»•ng sá»‘ lÆ°á»£ng khÃ¡ch hÃ ng");
		...
		lblSoLuongKhachHang = new JLabel("? khÃ¡ch hÃ ng");
	...
	private boolean KiemTraNhapLieu() {
		try {
			...
			if(nbd.compareTo(nkt)>0) {
				JOptionPane.showMessageDialog(this, "NgÃ y báº¯t Ä‘áº§u pháº£i bÃ© hÆ¡n ngÃ y káº¿t thÃºc!");
				return false;
			}
		} catch (Exception e) {
			JOptionPane.showMessageDialog(this, "Vui lÃ²ng chá»?n ngÃ y cáº§n thá»‘ng kÃª !");
			return false;
		}
		return true;
	}
	...
	public void actionPerformed(ActionEvent e) {	//txtTitleSoLuongVe, txtTitleTongDoanhThu, txtTittleSoLuongTour , txtTittleSoLuongKhachHang;
		...
		if(o.equals(btnthongke)) {
			if(KiemTraNhapLieu()) {
				...
				txtTitleSoLuongVe.setText("Tá»•ng sá»‘ lÆ°á»£ng vÃ© Ä‘Ã£ bÃ¡n tá»« ngÃ y " +sdfIn.format(jdbd.getDate()) + " Ä‘áº¿n ngÃ y " +sdfIn.format(jdkt.getDate()));
				try {
					lblSoLuongVe.setText(String.valueOf(thongKe_DAO.tongSoLuongVeTheoNgayChon(tuNgay,denNgay)) +" vÃ©");
				} catch (RemoteException e4) {
					// TODO Auto-generated catch block
					e4.printStackTrace();
				}

				txtTitleTongDoanhThu.setText("Tá»•ng doanh thu tá»« ngÃ y " +sdfIn.format(jdbd.getDate()) + " Ä‘áº¿n ngÃ y " +sdfIn.format(jdkt.getDate()));
				try {
				...
				txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ hoÃ n thÃ nh"+sdfIn.format(jdbd.getDate()) + " Ä‘áº¿n ngÃ y " +sdfIn.format(jdkt.getDate()));
...
//				lblSoLuongKhachHang.setText(String.valueOf(formatter.format(tk_dao.DoanhThuTheoNgayChon(tuNgay,denNgay))) +" khÃ¡ch hÃ ng");
				...
				txtTitleTopTour.setText("Top tour Ä‘Ã£ bÃ¡n tá»« ngÃ y "+sdfIn.format(jdbd.getDate())+" Ä‘áº¿n ngÃ y "+sdfIn.format(jdkt.getDate()));
				try {
					loadTK();
			...
			DecimalFormat formatter = new DecimalFormat("###,###,###,###");
			txtTitleSoLuongVe.setText("Tá»•ng sá»‘ lÆ°á»£ng vÃ© Ä‘Ã£ bÃ¡n trong quÃ½ IV "+ (String) cbxChonNam.getSelectedItem());
			try {
				lblSoLuongVe.setText(String.valueOf(thongKe_DAO.SoLuongVeTheoQuy((String) cbxChonNam.getSelectedItem(),"10","11","12") +" vÃ©"));
			} catch (RemoteException e4) {
				// TODO Auto-generated catch block
				e4.printStackTrace();
			}

			txtTitleTongDoanhThu.setText("Tá»•ng doanh thu trong quÃ½ IV nÄƒm " + (String) cbxChonNam.getSelectedItem());
			try {
			...
			try {
				listTour = thongKe_DAO.thongKeSanPhamTheoQuy4((String) cbxChonNam.getSelectedItem(),"10","11","12");
			} catch (RemoteException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
			}
			...
			txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ hoÃ n thÃ nh trong quÃ½ IV nÄƒm " + (String) cbxChonNam.getSelectedItem());
			lblSoLuongTour.setText(String.valueOf(i +" tour"));
//
...
//			lblSoTienNgay.setText(String.valueOf(formatter.format(daoThongKe.DoanhThuTheoQuy((String) cbxChonNam.getSelectedItem(),"10","11","12"))+" VND"));
			...
			txtTitleTopTour.setText("Top sáº£n pháº©m Ä‘Ã£ bÃ¡n trong quÃ½ IV nÄƒm " + (String) cbxChonNam.getSelectedItem());		
			...
			txtTitleSoLuongVe.setText("Tá»•ng sá»‘ lÆ°á»£ng vÃ© Ä‘Ã£ bÃ¡n trong quÃ½ IV "+ (String) cbxChonNam.getSelectedItem());
			try {
				lblSoLuongVe.setText(String.valueOf(thongKe_DAO.SoLuongVeTheoQuy((String) cbxChonNam.getSelectedItem(),"7","8","9") +" vÃ©"));
			} catch (RemoteException e4) {
				// TODO Auto-generated catch block
				e4.printStackTrace();
			}
			...
			try {
				listTour = thongKe_DAO.thongKeSanPhamTheoQuy4((String) cbxChonNam.getSelectedItem(),"7","8","9");
			} catch (RemoteException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
			}
			...
			txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ hoÃ n thÃ nh trong quÃ½ III nÄƒm " + (String) cbxChonNam.getSelectedItem());
			lblSoLuongTour.setText(String.valueOf(i +" tour"));
//
...
//
			txtTitleTopTour.setText("Top sáº£n pháº©m Ä‘Ã£ bÃ¡n trong quÃ½ III nÄƒm " + (String) cbxChonNam.getSelectedItem());		
			...
			txtTitleSoLuongVe.setText("Tá»•ng sá»‘ lÆ°á»£ng vÃ© Ä‘Ã£ bÃ¡n trong quÃ½ IV "+ (String) cbxChonNam.getSelectedItem());
			try {
				lblSoLuongVe.setText(String.valueOf(thongKe_DAO.SoLuongVeTheoQuy((String) cbxChonNam.getSelectedItem(),"4","5","6") +" vÃ©"));
			} catch (RemoteException e4) {
				// TODO Auto-generated catch block
				e4.printStackTrace();
			}
			...
			try {
				listTour = thongKe_DAO.thongKeSanPhamTheoQuy4((String) cbxChonNam.getSelectedItem(),"4","5","6");
			} catch (RemoteException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
			}
			...
			txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ hoÃ n thÃ nh trong quÃ½ II nÄƒm " + (String) cbxChonNam.getSelectedItem());
			lblSoLuongTour.setText(String.valueOf(i +" tour"));
//
...
//
			txtTitleTopTour.setText("Top sáº£n pháº©m Ä‘Ã£ bÃ¡n trong quÃ½ II nÄƒm " + (String) cbxChonNam.getSelectedItem());
//
			try {
			...
			txtTitleSoLuongVe.setText("Tá»•ng sá»‘ lÆ°á»£ng vÃ© Ä‘Ã£ bÃ¡n trong quÃ½ IV "+ (String) cbxChonNam.getSelectedItem());
			try {
				lblSoLuongVe.setText(String.valueOf(thongKe_DAO.SoLuongVeTheoQuy((String) cbxChonNam.getSelectedItem(),"1","2","3") +" vÃ©"));
			} catch (RemoteException e4) {
				// TODO Auto-generated catch block
				e4.printStackTrace();
			}
			...
			try {
				listTour = thongKe_DAO.thongKeSanPhamTheoQuy4((String) cbxChonNam.getSelectedItem(),"1","2","3");
			} catch (RemoteException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
			}
			...
			txtTittleSoLuongTour.setText("Sá»‘ lÆ°á»£ng tour Ä‘Ã£ hoÃ n thÃ nh trong quÃ½ I nÄƒm " + (String) cbxChonNam.getSelectedItem());
			lblSoLuongTour.setText(String.valueOf(i +" tour"));
//
...
//
	...
	public void loadTK() throws SQLException, RemoteException {
		...
		table.removeAll();
		listTour = thongKe_DAO.thongKeTheoNgay(tuNgay,denNgay);
		listTour.sort(((o2, o1) -> Double.compare(o1.getGiaTour(), o2.getGiaTour())));
		int i = 1;
		for(Tour t : listTour) {
			modeltable.addRow(new Object[] {i++,t.getTenTour(),formatter.format(t.getGiaTour())+ "VND"});
		}
	}
	public void loadTKTheoQuy4(String thang1, String thang2, String thang3) throws SQLException, RemoteException {
		...
		modeltable.setRowCount(0);
		table.removeAll();
		listTour = thongKe_DAO.thongKeSanPhamTheoQuy4((String) cbxChonNam.getSelectedItem(),thang1, thang2, thang3);
		listTour.sort(((o2, o1) -> Double.compare(o1.getGiaTour(), o2.getGiaTour())));
		int i = 1;
		for(Tour t : listTour) {
			modeltable.addRow(new Object[] {i++,t.getTenTour(),formatter.format(t.getGiaTour())+ "VND"});
