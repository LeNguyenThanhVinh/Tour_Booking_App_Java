...
//		pnQLKH = new UI_ThongTinKhachHang();
		pnQLKH = new GIAODIEN_QuanLiKhachHang();
		pnQLTOUR = new JPanel();
...
//		pnHDV = new UI_ThongTinHuongDanVien();
		...
		JLabel lblTieuDe = new JLabel("Quáº£n LÃ½ Tour Du Lá»‹ch");
		...
		nButton1 = new JLabel("Quáº£n lÃ½ khÃ¡ch hÃ ng", SwingConstants.CENTER);
		btnQLKH = new JButton("");
		...
		nButton2 = new JLabel("Quáº£n lÃ½ nhÃ¢n viÃªn", SwingConstants.CENTER);
		btnQLNV = new JButton("");
		...
		nButton3 = new JLabel("Quáº£n lÃ½ thá»‘ng kÃª", SwingConstants.CENTER);
		...
		nButton4 = new JLabel("Quáº£n lÃ½ tour", SwingConstants.CENTER);
		...
		nButton5 = new JLabel("Ä�áº·t vÃ©", SwingConstants.CENTER);
		btnQLVe = new JButton("");
		...
		nButton6 = new JLabel("Quáº£n lÃ­ Ä‘á»‹a danh", SwingConstants.CENTER);
		...
		nButton7 = new JLabel("Quáº£n lÃ½ hÆ°á»›ng dáº«n viÃªn", SwingConstants.CENTER);
		btnHDV = new JButton("");
		...
		nButton8 = new JLabel("Ä�Äƒng xuáº¥t", SwingConstants.CENTER);
		...
		nButton9 = new JLabel("Trang Chá»§", SwingConstants.CENTER);
	...
	public void actionPerformed(ActionEvent e) {
		...
		//Nam
			...
			JFrame f= new JFrame();
			int hoi=JOptionPane.showConfirmDialog(f, "Báº¡n cÃ³ cháº¯c muá»‘n Ä‘Äƒng xuáº¥t?","ChÃº Ã½",JOptionPane.YES_NO_OPTION);
...
//		NhanVien_DAO nhanVien_DAO = (NhanVien_DAO) Naming.lookup("rmi://DESKTOP-O44ASRI:9999/nhanVien_DAO");
//		nv.modeltable= nhanVien_DAO.getAllNV();
