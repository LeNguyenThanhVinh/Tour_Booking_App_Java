...
public class GIAODIEN_ThongTinKhachHang extends JFrame implements ActionListener {
	...
	public GIAODIEN_ThongTinKhachHang(DiaDanh dd, boolean flag)
		...
		cbxTinhThanh.addItem("An Giang ");
		cbxTinhThanh.addItem("Bà rịa – Vũng tàu");
		cbxTinhThanh.addItem("Bắc Giang");
		cbxTinhThanh.addItem("Bắc Kạn");
		cbxTinhThanh.addItem("Bạc Liêu");
		cbxTinhThanh.addItem("Bắc Ninh");
		cbxTinhThanh.addItem("Bến Tre");
		cbxTinhThanh.addItem("Bình Định");
		cbxTinhThanh.addItem("Bình Dương");
		cbxTinhThanh.addItem("Bình Phước");
		cbxTinhThanh.addItem("Bình Thuận");
		cbxTinhThanh.addItem("Cà Mau");
		cbxTinhThanh.addItem("Cần Thơ");
		cbxTinhThanh.addItem("Cao Bằng ");
		cbxTinhThanh.addItem("Đà Nẵng");
		cbxTinhThanh.addItem("Đắk Lắk");
		cbxTinhThanh.addItem("Đắk Nông");
		cbxTinhThanh.addItem("Điện Biên");
		cbxTinhThanh.addItem("Đồng Nai");
		cbxTinhThanh.addItem("Đồng Tháp");
		cbxTinhThanh.addItem("Gia Lai");
		cbxTinhThanh.addItem("Hà Giang");
		cbxTinhThanh.addItem("Hà Nam");
		cbxTinhThanh.addItem("Hà Nội ");
		cbxTinhThanh.addItem("Hà Tĩnh");
		cbxTinhThanh.addItem("Hải Dương ");
		cbxTinhThanh.addItem("Hải Phòng");
		cbxTinhThanh.addItem("Hậu Giang");
		cbxTinhThanh.addItem("Hòa Bình");
		cbxTinhThanh.addItem("Hưng Yên");
		cbxTinhThanh.addItem("Khánh Hòa");
		cbxTinhThanh.addItem("Kiên Giang");
		cbxTinhThanh.addItem("Kon Tum");
		cbxTinhThanh.addItem("Lai Châu");
		cbxTinhThanh.addItem("Lâm Đồng");
		cbxTinhThanh.addItem("Lạng Sơn");
		cbxTinhThanh.addItem("Lào Cai");
		cbxTinhThanh.addItem("Long An");
		cbxTinhThanh.addItem("Nam Định");
		cbxTinhThanh.addItem("Nghệ An");
		cbxTinhThanh.addItem("Ninh Bình");
		cbxTinhThanh.addItem("Ninh Thuận");
		cbxTinhThanh.addItem("Phú Thọ");
		cbxTinhThanh.addItem("Phú Yên");
		cbxTinhThanh.addItem("Quảng Bình");
		cbxTinhThanh.addItem("Quảng Nam");
		cbxTinhThanh.addItem("Quảng Ngãi");
		cbxTinhThanh.addItem("Quảng Ninh");
		cbxTinhThanh.addItem("Quảng Trị");
		cbxTinhThanh.addItem("Sóc Trăng");
		cbxTinhThanh.addItem("Sơn La");
		cbxTinhThanh.addItem("Tây Ninh");
		cbxTinhThanh.addItem("Thái Bình");
		cbxTinhThanh.addItem("Thái Nguyên");
		cbxTinhThanh.addItem("Thanh Hóa");
		cbxTinhThanh.addItem("Thừa Thiên Huế");
		cbxTinhThanh.addItem("Tiền Giang");
		cbxTinhThanh.addItem("Thành phố Hồ Chí Minh");
		cbxTinhThanh.addItem("Trà Vinh");
		cbxTinhThanh.addItem("Tuyên Quang");
		cbxTinhThanh.addItem("Vĩnh Long");
		cbxTinhThanh.addItem("Vĩnh Phúc");
					...
					if (validData()) {
						...
						try {
							if (diaDanh_DAO.themDiaDanh(diadanh)) {
								...
								qldd.modeltable.addRow(new Object[] { maDiaDanh, tenDiaDanh, moTa, tinhThanh });
							}
